...
namespace ucenci
{
    public partial class Dijakics : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                NpgsqlCommand com = new NpgsqlCommand("INSERT INTO Dijaki (ime,priimek,darum_roj,telefon,email,opis) VALUES(" + textBox1.Text + "," + textBox2.Text + "," + textBox3.Text + "," +textBox4.Text + "," + textBox6.Text + "," + textBox5.Text + ")", con);
